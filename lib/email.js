...
<div style="font-family:Arial,sans-serif;max-width:600px">
  ...
  <div style="padding:24px 20px;background:#fff">
    ...
    <table style="width:100%;font-size:13px;border-collapse:collapse">
      ...
      <tr><td style="color:#888;padding:4px 0">Total Bid</td><td style="font-weight:700;font-size:15px">${money2(c.totalBid)}</td></tr>
      <tr><td style="color:#888;padding:4px 0">Material Weight</td><td>${Math.round(c.materialWeight).toLocaleString()} lb</td></tr>
    </table>
...
module.exports = { sendReadyToSubmit, sendFeedback, sendInvite, sendWonNotification, isConfigured, graphConfigured, smtpConfigured };
