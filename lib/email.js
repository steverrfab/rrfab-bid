...
async function sendBidReminder(toEmail, toName, bid, kind, isOwner = true) {
  ...
  const url = frontendUrl() + '/#/estimate/' + bid.id;
  ...
  const html = `
    <div style="font-family:-apple-system,Segoe UI,Roboto,sans-serif;color:#222;max-width:600px;">
      ...
      <a href="${url}" style="display:inline-block;background:#ff6b35;color:#fff;font-weight:600;font-size:14px;padding:10px 24px;border-radius:6px;text-decoration:none;">Open the bid</a>
